            ...
            <View >
              ...
              >
                {item?.description?.length > 160
                  ? item?.description
                  : item?.description.substr(0, 16)}
              </Text>
            </View>

            {item?.profileImages?.slice(0, 1).map((item, index) => (
              <Image style={{ width: 280, height: 280, resizeMode: "cover", borderRadius: 5, }} source={{ uri: item }} />
            ))}
          </View>
        ...
        <View>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 12, }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 20 }}>
              ...
              >
                <Entypo name="cross" size={27} color="#DE3163" />
              </Pressable>
        ...
        <View>
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 20 }}>
              ...
              >
                <Entypo name="cross" size={27} color="#0066b2" />
              </Pressable>
